...
//! 
//! ```rust
//! # use crate::frame::types::deserialize::row::DeserializeValue;
//! # use crate::frame::response::result::ColumnType;
//! # use crate::frame::frame_errors::ParseError;
//! impl<'frame> DeserializeValue<'frame> for Vec<u8> {
//!     fn type_check(typ: &ColumnType) -> Result<(), ParseError> {
//!          if let CqlType::Bytes = typ {
//!              return Ok(());
//!          }
...
//! # use crate::frame::response::result::ColumnType;
//! # use crate::frame::frame_errors::ParseError;
//! impl<'a, 'frame> DeserializeValue<'frame> for &'a [u8]
//! where
//!     'frame: 'a,
//! {
//!     fn type_check(typ: &ColumnType) -> Result<(), ParseError> {
...
//! 
//! During deserialization, a type can obtain a `Bytes` subslice that point
//! to the serialized value. This approach combined advantages of the previous
...
//! # use crate::frame::frame_errors::ParseError;
//! # use bytes::Bytes;
//! impl<'frame> DeserializeValue<'frame> for Bytes {
//!     fn type_check(typ: &ColumnType) -> Result<(), ParseError> {
//!          if let CqlType::Bytes = typ {
//!              return Ok(());
//!          }
