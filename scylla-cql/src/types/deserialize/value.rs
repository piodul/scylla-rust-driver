...
where
    T: DeserializeCql + secrecy::Zeroize,
{
    fn type_check(typ: &ColumnType) -> Result<(), ParseError> {
        <T as DeserializeCql<'frame>>::type_check(typ)
    }
    ...
    fn deserialize(
        ...
        <T as DeserializeCql<'frame>>::type_check(typ).map(secrecy::Secret::new)
    }
}
...
mod tests {
    ...
    fn test_udt_loose_ordering() {
        ...
        // The last column is missing in serialized form - it should treat
    ...
    fn test_from_cql_value_compatibility() {
        ...
        // empty values
        // TODO: FromCqlVal doesn't have support for this
        ...
        compat_check::<HashSet<i32>>(&list_type, list.clone());
        ...
        compat_check::<HashMap<i32, String>>(&map_type, map.clone());
