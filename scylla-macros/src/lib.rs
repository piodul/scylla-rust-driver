...
/// #[derive(DeserializeRow)] generates implementation of DeserializeRow
/// for given struct.
///
/// TODO: More comprehensive description
...
/// #[derive(DeserializeCql)] generates implementation of DeserializeCql
/// for given UDT struct.
///
/// TODO: More comprehensive description
#[proc_macro_derive(DeserializeCql, attributes(scylla, scylla_crate))]
