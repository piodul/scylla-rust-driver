...
pub type NewDeserApiSession = GenericSession<CurrentDeserializationApi>;
pub type Session = GenericSession<LegacyDeserializationApi>;
...
impl GenericSession<CurrentDeserializationApi> {
    ...
    pub fn make_shared_session_with_legacy_api(&self) -> NewDeserApiSession {
        NewDeserApiSession {
...
impl GenericSession<LegacyDeserializationApi> {
    ...
    /// metadata.
    pub fn make_shared_session_with_new_api(&self) -> NewDeserApiSession {
        NewDeserApiSession {
            cluster: self.cluster.clone(),
            auto_await_schema_agreement_timeout: self.auto_await_schema_agreement_timeout,
            default_execution_profile_handle: self.default_execution_profile_handle.clone(),
